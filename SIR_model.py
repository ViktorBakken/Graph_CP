...
spread=0.3 # The chance an infection will spread through an edge
budget=15 # The interdiction budget
intervention_step={3} # The steps in the simulation where interdiction occur
...
infected_nodes= {63} # Which nodes are infected at start
Run_single=False
Double_trouble=True
#-------------------------------------------------------------------------------------------------------------------------------------------------
# 15
...
if not Run_single:
    ...
    runs= 20 if Double_trouble else 1
    Reccomended=[]
    start_inf=[]
    for run in range(runs):
        ...
        #Determine T
            ...
            #     AreaUnderData.append(sum(data))


            # plt.plot(AreaUnderData)
            # plt.xlabel("Budget")
            # plt.ylabel("Area under infected nodes")
            # plt.title(f"Area under infected nodes at end of simulation (step {time_range}), with {spread} spread after varying {interdiction_type} interdiction  budgets at {intervention_step}")
            # plt.show()  
