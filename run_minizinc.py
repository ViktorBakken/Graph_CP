...
def interdiction_minizinc(num_nodes=15,budget=4,infected_nodes=None,critical_nodes=None,graph_edges=None, interdiction_type="edge",solver_name="highs", displ=False,layout=None):
    k=budget
...
if __name__=="__main__":
    ...
    for solver in sovl:
        print(solver)
        start= time.time()
        interdiction_minizinc(solver_name=solver,displ=displ)
